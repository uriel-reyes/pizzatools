...
const generateRandomPizzaOrder = () => {
    ...
    for (let i = 0; i < pizzaCount; i++) {
        ...
        while (!isUnique) {
            if (useCommonPizza) {
                ...
                const toppings = getRandomItems(availableIngredients.filter(i => i !== "cheese"), toppingCount);
                // Always add cheese
...
const createCartWithCustomerData = (customer, pizzas) => {
